const SkillDataGeneral = [
  ...
  },
  {
    id: '10141',
    name: '熱血☆アミーゴ',
    actCond: [['is_finalcorner==1', 'on_corner==0', 'hp_per>=30', 'order<=2']],
    duration: 50000,
    cd: 5000000,
    effects: [
      {
  ...
  },
  {
    id: '10271',
    name: '燃えろ筋肉！',
    actCond: [['phase>=2', 'on_corner==1', 'order_rate>=65', 'order_rate<=70']],
    duration: 40000,
    cd: 5000000,
    effects: [
      {
  ...
  },
  {
    ...
    actCond: [
      ['distance_rate>=50', 'on_corner==1', 'order>=3', 'order_rate<=40'],
    ],
    duration: 0,
    cd: 5000000,
    effects: [
  ...
  },
  {
    ...
    name: 'ワクワクよーいドン',
    actCond: [
      ['is_finalcorner==1', 'on_corner==1', 'order_rate>50', 'near_count>=1'],
    ],
    duration: 0,
    cd: 5000000,
    effects: [
  ...
  },
  {
    ...
    name: 'ヴィクトリーショット！',
    actCond: [
      ['is_finalcorner==1', 'on_corner==1', 'order>=3', 'order_rate<=50'],
    ],
    duration: 40000,
    cd: 5000000,
    effects: [
  ...
  },
  {
    id: '100131',
    name: '貴顕の使命を果たすべく',
    actCond: [['is_finalcorner==1', 'on_corner==1', 'distance_diff_rate<=30']],
    duration: 50000,
    cd: 5000000,
    effects: [
      {
  ...
  },
  {
    ...
    name: '汝、皇帝の神威を見よ',
    actCond: [
      ['is_finalcorner==1', 'change_order_up_end_after>=3', 'on_corner==0'],
    ],
    duration: 50000,
    cd: 5000000,
    effects: [
  ...
  },
  {
    id: '100201',
    name: 'アングリング×スキーミング',
    actCond: [['phase>=2', 'on_corner==1', 'order==1']],
    duration: 40000,
    cd: 5000000,
    effects: [
      {
  ...
  },
  {
    ...
    name: 'キラキラ☆STARDOM',
    actCond: [
      ['phase==1', 'on_corner==0', 'order==1', 'bashin_diff_behind<=1'],
    ],
    duration: 50000,
    cd: 5000000,
    effects: [
  ...
  },
  {
    ...
    actCond: [
      [
        ...
        'order<=5',
        'order_rate<=50',
        'overtake_target_no_order_up_time>=2',
      ],
    ],
    duration: 50000,
    cd: 5000000,
  ...
  },
  {
    id: '200641',
    name: '迫る影',
    actCond: [['running_style==4', 'is_lastspurt==1', 'on_corner==0']],
    duration: 9000,
    cd: 5000000,
    effects: [
      {
  ...
  },
  {
    ...
    name: '内的体験',
    actCond: [
      ['distance_type==4', 'is_finalcorner==1', 'on_corner==1', 'lane_type==0'],
    ],
    duration: 30000,
    cd: 5000000,
    effects: [
  ...
  },
  {
    ...
    actCond: [
      [
        'running_style_count_senko_otherself>=1',
        'phase_random==0',
        'accumulatetime>=5',
      ],
    ],
  ...
  },
  {
    ...
    name: '短距離コーナー◎',
    actCond: [
      ['distance_type==1', 'corner_random==1'],
      ['distance_type==1', 'corner_random==2'],
      ['distance_type==1', 'corner_random==3'],
      ['distance_type==1', 'corner_random==4'],
    ],
    duration: 30000,
    cd: 5000000,
    effects: [
  ...
  },
  {
    ...
    name: 'マイルコーナー◎',
    actCond: [
      ['distance_type==2', 'corner_random==1'],
      ['distance_type==2', 'corner_random==2'],
      ['distance_type==2', 'corner_random==3'],
      ['distance_type==2', 'corner_random==4'],
    ],
    duration: 30000,
    cd: 5000000,
    effects: [
  ...
  },
  {
    ...
    name: '中距離コーナー◎',
    actCond: [
      ['distance_type==3', 'corner_random==1'],
      ['distance_type==3', 'corner_random==2'],
      ['distance_type==3', 'corner_random==3'],
      ['distance_type==3', 'corner_random==4'],
    ],
    duration: 30000,
    cd: 5000000,
    effects: [
  ...
  },
  {
    ...
    name: '神業ステップ',
    actCond: [
      ['distance_type==3', 'is_move_lane==1', 'accumulatetime>=10'],
      ['distance_type==3', 'is_move_lane==2', 'accumulatetime>=10'],
    ],
    duration: 0,
    cd: 5000000,
    effects: [
  ...
  },
  {
    ...
    name: '長距離コーナー◎',
    actCond: [
      ['distance_type==4', 'corner_random==1'],
      ['distance_type==4', 'corner_random==2'],
      ['distance_type==4', 'corner_random==3'],
      ['distance_type==4', 'corner_random==4'],
    ],
    duration: 30000,
    cd: 5000000,
    effects: [
  ...
  },
  {
    ...
    name: '逃げコーナー◎',
    actCond: [
      ['running_style==1', 'corner_random==1'],
      ['running_style==1', 'corner_random==2'],
      ['running_style==1', 'corner_random==3'],
      ['running_style==1', 'corner_random==4'],
    ],
    duration: 30000,
    cd: 5000000,
    effects: [
  ...
  },
  {
    ...
    name: '先行コーナー◎',
    actCond: [
      ['running_style==2', 'corner_random==1'],
      ['running_style==2', 'corner_random==2'],
      ['running_style==2', 'corner_random==3'],
      ['running_style==2', 'corner_random==4'],
    ],
    duration: 30000,
    cd: 5000000,
    effects: [
  ...
  },
  {
    ...
    name: '技巧派',
    actCond: [
      ['running_style==2', 'is_move_lane==1'],
      ['running_style==2', 'is_move_lane==2'],
    ],
    duration: 18000,
    cd: 5000000,
    effects: [
  ...
  },
  {
    ...
    name: '差しコーナー◎',
    actCond: [
      ['running_style==3', 'corner_random==1'],
      ['running_style==3', 'corner_random==2'],
      ['running_style==3', 'corner_random==3'],
      ['running_style==3', 'corner_random==4'],
    ],
    duration: 30000,
    cd: 5000000,
    effects: [
  ...
  },
  {
    ...
    name: '追込コーナー◎',
    actCond: [
      ['running_style==4', 'corner_random==1'],
      ['running_style==4', 'corner_random==2'],
      ['running_style==4', 'corner_random==3'],
      ['running_style==4', 'corner_random==4'],
    ],
    duration: 30000,
    cd: 5000000,
    effects: [
  ...
  },
  {
    ...
    name: '視界良好！異常なし！',
    actCond: [
      ['running_style==4', 'is_move_lane==1'],
      ['running_style==4', 'is_move_lane==2'],
    ],
    duration: 30000,
    cd: 5000000,
    effects: [
