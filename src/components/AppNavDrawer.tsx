...
Divider,
MenuItem,
Menu,Drawer, List } from '@mui/material';
...
function PersistScroll(props: any) {
...
const AppNavDrawer = (props: any) => {
  ...
  const {disablePermanent, mobileOpen, onClose, onOpen} = useSelector(
  ...
  }, [activePage, pages, onClose, anchorEl, setAnchorEl]);
